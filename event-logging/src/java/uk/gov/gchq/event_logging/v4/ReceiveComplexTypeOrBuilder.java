...
public interface ReceiveComplexTypeOrBuilder extends
   ...
   * @return The source.
   */
  uk.gov.gchq.event_logging.v4.ReceiveComplexType.SourceType getSource();
  /**
   * <pre>
   * The initiator(s) of the object or resource sent or received. An initiator can be a user and/or device.
   * </pre>
   ...
   * <code>.event_logging.v4.ReceiveComplexType.SourceType source = 1 [json_name = "source", (.buf.validate.field) = { ... }</code>
   */
  uk.gov.gchq.event_logging.v4.ReceiveComplexType.SourceTypeOrBuilder getSourceOrBuilder();
   ...
   */
  uk.gov.gchq.event_logging.v4.ReceiveComplexType.DestinationType getDestination();
  /**
   * <pre>
   * The destination(s) of the object or resource sent or received. A destination can be a user and/or device.
   * </pre>
   ...
   * <code>.event_logging.v4.ReceiveComplexType.DestinationType destination = 2 [json_name = "destination", (.buf.validate.field) = { ... }</code>
   */
  uk.gov.gchq.event_logging.v4.ReceiveComplexType.DestinationTypeOrBuilder getDestinationOrBuilder();
