...
public interface CopyMoveOutcomeComplexTypeOrBuilder extends
   ...
   */
  uk.gov.gchq.event_logging.v4.CopyMoveOutcomeComplexType.AuthServiceType getAuthService();
  /**
   * <pre>
   * A description of the authorisation service that was used to decide if the action was permitted.
   * </pre>
   ...
   * <code>.event_logging.v4.CopyMoveOutcomeComplexType.AuthServiceType auth_service = 3 [json_name = "authService"];</code>
   */
  uk.gov.gchq.event_logging.v4.CopyMoveOutcomeComplexType.AuthServiceTypeOrBuilder getAuthServiceOrBuilder();
   ...
   * @return The reason.
   */
  uk.gov.gchq.event_logging.v4.CopyMoveOutcomeReasonSimpleType getReason();
