...
public interface DocumentComplexTypeOrBuilder extends
   ...
   */
  uk.gov.gchq.event_logging.v4.DocumentComplexType.PermissionsType getPermissions();
  /**
   * <pre>
   * The collection of permissions associated with the object, e.g. write access being granted to a list of named users.
   * </pre>
   ...
   * <code>.event_logging.v4.DocumentComplexType.PermissionsType permissions = 9 [json_name = "permissions"];</code>
   */
  uk.gov.gchq.event_logging.v4.DocumentComplexType.PermissionsTypeOrBuilder getPermissionsOrBuilder();
