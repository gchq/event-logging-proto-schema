...
public interface BannerComplexTypeOrBuilder extends
   ...
   */
  uk.gov.gchq.event_logging.v4.BannerComplexType.PermissionsType getPermissions();
  /**
   * <pre>
   * The collection of permissions associated with the object, e.g. write access being granted to a list of named users.
   * </pre>
   ...
   * <code>.event_logging.v4.BannerComplexType.PermissionsType permissions = 9 [json_name = "permissions"];</code>
   */
  uk.gov.gchq.event_logging.v4.BannerComplexType.PermissionsTypeOrBuilder getPermissionsOrBuilder();
