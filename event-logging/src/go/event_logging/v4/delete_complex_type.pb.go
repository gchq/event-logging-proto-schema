// event_logging/v4/delete_complex_type.proto at 0:0
...
type DeleteComplexType struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	ChoiceWrapper []*DeleteComplexType_ChoiceWrapperDeleteComplexType `protobuf:"bytes,1,rep,name=choice_wrapper,json=choiceWrapper,proto3" json:"choice_wrapper,omitempty"`
...
func (x *DeleteComplexType) Reset() {
	*x = DeleteComplexType{}
	if protoimpl.UnsafeEnabled {
		mi := &file_event_logging_v4_delete_complex_type_proto_msgTypes[0]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *DeleteComplexType) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeleteComplexType) ProtoMessage() {}

func (x *DeleteComplexType) ProtoReflect() protoreflect.Message {
	mi := &file_event_logging_v4_delete_complex_type_proto_msgTypes[0]
...
// Deprecated: Use DeleteComplexType.ProtoReflect.Descriptor instead.
func (*DeleteComplexType) Descriptor() ([]byte, []int) {
	return file_event_logging_v4_delete_complex_type_proto_rawDescGZIP(), []int{0}
}

func (x *DeleteComplexType) GetChoiceWrapper() []*DeleteComplexType_ChoiceWrapperDeleteComplexType {
	if x != nil {
...
func (x *DeleteComplexType) GetOutcome() *OutcomeComplexType {
	if x != nil {
		return x.Outcome
	}
	return nil
...
func (x *DeleteComplexType) GetData() []*DataComplexType {
	if x != nil {
		return x.Data
	}
	return nil
...
type DeleteComplexType_ChoiceWrapperDeleteComplexType struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *DeleteComplexType_ChoiceWrapperDeleteComplexType) Reset() {
	*x = DeleteComplexType_ChoiceWrapperDeleteComplexType{}
	if protoimpl.UnsafeEnabled {
		mi := &file_event_logging_v4_delete_complex_type_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *DeleteComplexType_ChoiceWrapperDeleteComplexType) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeleteComplexType_ChoiceWrapperDeleteComplexType) ProtoMessage() {}

func (x *DeleteComplexType_ChoiceWrapperDeleteComplexType) ProtoReflect() protoreflect.Message {
	mi := &file_event_logging_v4_delete_complex_type_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeleteComplexType_ChoiceWrapperDeleteComplexType.ProtoReflect.Descriptor instead.
func (*DeleteComplexType_ChoiceWrapperDeleteComplexType) Descriptor() ([]byte, []int) {
	return file_event_logging_v4_delete_complex_type_proto_rawDescGZIP(), []int{0, 0}
}

func (x *DeleteComplexType_ChoiceWrapperDeleteComplexType) GetAssociation() *AssociationComplexType {
	if x != nil {
...
func (x *DeleteComplexType_ChoiceWrapperDeleteComplexType) GetBanner() *BannerComplexType {
	if x != nil {
		return x.Banner
	}
	return nil
...
func (x *DeleteComplexType_ChoiceWrapperDeleteComplexType) GetChat() *ChatComplexType {
	if x != nil {
		return x.Chat
	}
	return nil
...
func (x *DeleteComplexType_ChoiceWrapperDeleteComplexType) GetConfiguration() *ConfigurationComplexType {
	if x != nil {
...
func (x *DeleteComplexType_ChoiceWrapperDeleteComplexType) GetCriteria() *CriteriaComplexType {
	if x != nil {
		return x.Criteria
	}
	return nil
...
func (x *DeleteComplexType_ChoiceWrapperDeleteComplexType) GetDocument() *DocumentComplexType {
	if x != nil {
		return x.Document
	}
	return nil
...
func (x *DeleteComplexType_ChoiceWrapperDeleteComplexType) GetEmail() *EmailComplexType {
	if x != nil {
		return x.Email
	}
	return nil
...
func (x *DeleteComplexType_ChoiceWrapperDeleteComplexType) GetFile() *FileComplexType {
	if x != nil {
		return x.File
	}
	return nil
...
func (x *DeleteComplexType_ChoiceWrapperDeleteComplexType) GetFolder() *FolderComplexType {
	if x != nil {
		return x.Folder
	}
	return nil
...
func (x *DeleteComplexType_ChoiceWrapperDeleteComplexType) GetGroup() *GroupComplexType {
	if x != nil {
		return x.Group
	}
	return nil
...
func (x *DeleteComplexType_ChoiceWrapperDeleteComplexType) GetGroupChat() *GroupChatComplexType {
	if x != nil {
		return x.GroupChat
	}
	return nil
...
func (x *DeleteComplexType_ChoiceWrapperDeleteComplexType) GetObject() *ObjectComplexType {
	if x != nil {
		return x.Object
	}
	return nil
...
func (x *DeleteComplexType_ChoiceWrapperDeleteComplexType) GetSearchResults() *SearchResultsComplexType {
	if x != nil {
...
func (x *DeleteComplexType_ChoiceWrapperDeleteComplexType) GetShortcut() *ShortcutComplexType {
	if x != nil {
		return x.Shortcut
	}
	return nil
...
func (x *DeleteComplexType_ChoiceWrapperDeleteComplexType) GetUser() *UserComplexType {
	if x != nil {
		return x.User
	}
	return nil
...
func (x *DeleteComplexType_ChoiceWrapperDeleteComplexType) GetVirtualSession() *VirtualSessionComplexType {
	if x != nil {
...
func (x *DeleteComplexType_ChoiceWrapperDeleteComplexType) GetVoip() *VoipComplexType {
	if x != nil {
		return x.Voip
	}
	return nil
...
func (x *DeleteComplexType_ChoiceWrapperDeleteComplexType) GetResource() *ResourceComplexType {
	if x != nil {
		return x.Resource
	}
	return nil
...
var File_event_logging_v4_delete_complex_type_proto protoreflect.FileDescriptor

var file_event_logging_v4_delete_complex_type_proto_rawDesc = []byte{
	0x0a, 0x2a, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x5f, 0x6c, 0x6f, 0x67, 0x67, 0x69, 0x6e, 0x67, 0x2f,
	0x76, 0x34, 0x2f, 0x64, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x5f, 0x63, 0x6f, 0x6d, 0x70, 0x6c, 0x65,
	...
	0x0a, 0x11, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x78, 0x54,
	...
	0x65, 0x6c, 0x65, 0x74, 0x65, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x78, 0x54, 0x79, 0x70, 0x65,
	0x2e, 0x43, 0x68, 0x6f, 0x69, 0x63, 0x65, 0x57, 0x72, 0x61, 0x70, 0x70, 0x65, 0x72, 0x44, 0x65,
	0x6c, 0x65, 0x74, 0x65, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x78, 0x54, 0x79, 0x70, 0x65, 0x42,
	...
	0x6f, 0x69, 0x63, 0x65, 0x57, 0x72, 0x61, 0x70, 0x70, 0x65, 0x72, 0x44, 0x65, 0x6c, 0x65, 0x74,
	...
	0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x78, 0x54, 0x79, 0x70,
...
var (
	file_event_logging_v4_delete_complex_type_proto_rawDescOnce sync.Once
	file_event_logging_v4_delete_complex_type_proto_rawDescData = file_event_logging_v4_delete_complex_type_proto_rawDesc
)

func file_event_logging_v4_delete_complex_type_proto_rawDescGZIP() []byte {
	file_event_logging_v4_delete_complex_type_proto_rawDescOnce.Do(func() {
		file_event_logging_v4_delete_complex_type_proto_rawDescData = protoimpl.X.CompressGZIP(file_event_logging_v4_delete_complex_type_proto_rawDescData)
	})
	return file_event_logging_v4_delete_complex_type_proto_rawDescData
}

var file_event_logging_v4_delete_complex_type_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_event_logging_v4_delete_complex_type_proto_goTypes = []interface{}{
	(*DeleteComplexType)(nil),                                // 0: event_logging.v4.DeleteComplexType
	(*DeleteComplexType_ChoiceWrapperDeleteComplexType)(nil), // 1: event_logging.v4.DeleteComplexType.ChoiceWrapperDeleteComplexType
...
var file_event_logging_v4_delete_complex_type_proto_depIdxs = []int32{
	1,  // 0: event_logging.v4.DeleteComplexType.choice_wrapper:type_name -> event_logging.v4.DeleteComplexType.ChoiceWrapperDeleteComplexType
	2,  // 1: event_logging.v4.DeleteComplexType.outcome:type_name -> event_logging.v4.OutcomeComplexType
	3,  // 2: event_logging.v4.DeleteComplexType.data:type_name -> event_logging.v4.DataComplexType
	4,  // 3: event_logging.v4.DeleteComplexType.ChoiceWrapperDeleteComplexType.association:type_name -> event_logging.v4.AssociationComplexType
	5,  // 4: event_logging.v4.DeleteComplexType.ChoiceWrapperDeleteComplexType.banner:type_name -> event_logging.v4.BannerComplexType
	6,  // 5: event_logging.v4.DeleteComplexType.ChoiceWrapperDeleteComplexType.chat:type_name -> event_logging.v4.ChatComplexType
	7,  // 6: event_logging.v4.DeleteComplexType.ChoiceWrapperDeleteComplexType.configuration:type_name -> event_logging.v4.ConfigurationComplexType
	8,  // 7: event_logging.v4.DeleteComplexType.ChoiceWrapperDeleteComplexType.criteria:type_name -> event_logging.v4.CriteriaComplexType
	9,  // 8: event_logging.v4.DeleteComplexType.ChoiceWrapperDeleteComplexType.document:type_name -> event_logging.v4.DocumentComplexType
	10, // 9: event_logging.v4.DeleteComplexType.ChoiceWrapperDeleteComplexType.email:type_name -> event_logging.v4.EmailComplexType
	11, // 10: event_logging.v4.DeleteComplexType.ChoiceWrapperDeleteComplexType.file:type_name -> event_logging.v4.FileComplexType
	12, // 11: event_logging.v4.DeleteComplexType.ChoiceWrapperDeleteComplexType.folder:type_name -> event_logging.v4.FolderComplexType
	13, // 12: event_logging.v4.DeleteComplexType.ChoiceWrapperDeleteComplexType.group:type_name -> event_logging.v4.GroupComplexType
	14, // 13: event_logging.v4.DeleteComplexType.ChoiceWrapperDeleteComplexType.group_chat:type_name -> event_logging.v4.GroupChatComplexType
	15, // 14: event_logging.v4.DeleteComplexType.ChoiceWrapperDeleteComplexType.object:type_name -> event_logging.v4.ObjectComplexType
	16, // 15: event_logging.v4.DeleteComplexType.ChoiceWrapperDeleteComplexType.search_results:type_name -> event_logging.v4.SearchResultsComplexType
	17, // 16: event_logging.v4.DeleteComplexType.ChoiceWrapperDeleteComplexType.shortcut:type_name -> event_logging.v4.ShortcutComplexType
	18, // 17: event_logging.v4.DeleteComplexType.ChoiceWrapperDeleteComplexType.user:type_name -> event_logging.v4.UserComplexType
	19, // 18: event_logging.v4.DeleteComplexType.ChoiceWrapperDeleteComplexType.virtual_session:type_name -> event_logging.v4.VirtualSessionComplexType
	20, // 19: event_logging.v4.DeleteComplexType.ChoiceWrapperDeleteComplexType.voip:type_name -> event_logging.v4.VoipComplexType
	21, // 20: event_logging.v4.DeleteComplexType.ChoiceWrapperDeleteComplexType.resource:type_name -> event_logging.v4.ResourceComplexType
...
func init() { file_event_logging_v4_delete_complex_type_proto_init() }
func file_event_logging_v4_delete_complex_type_proto_init() {
	if File_event_logging_v4_delete_complex_type_proto != nil {
		return
	}
	...
	if !protoimpl.UnsafeEnabled {
		file_event_logging_v4_delete_complex_type_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DeleteComplexType); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_event_logging_v4_delete_complex_type_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DeleteComplexType_ChoiceWrapperDeleteComplexType); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_event_logging_v4_delete_complex_type_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_event_logging_v4_delete_complex_type_proto_goTypes,
		DependencyIndexes: file_event_logging_v4_delete_complex_type_proto_depIdxs,
		MessageInfos:      file_event_logging_v4_delete_complex_type_proto_msgTypes,
	}.Build()
	File_event_logging_v4_delete_complex_type_proto = out.File
	file_event_logging_v4_delete_complex_type_proto_rawDesc = nil
	file_event_logging_v4_delete_complex_type_proto_goTypes = nil
	file_event_logging_v4_delete_complex_type_proto_depIdxs = nil
}
