// event_logging/v4/object_complex_type.proto at 0:0
...
type ObjectComplexType struct {
	...
	Permissions *ObjectComplexType_PermissionsType `protobuf:"bytes,9,opt,name=permissions,proto3" json:"permissions,omitempty"`
...
func (x *ObjectComplexType) Reset() {
	*x = ObjectComplexType{}
	if protoimpl.UnsafeEnabled {
		mi := &file_event_logging_v4_object_complex_type_proto_msgTypes[0]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ObjectComplexType) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ObjectComplexType) ProtoMessage() {}

func (x *ObjectComplexType) ProtoReflect() protoreflect.Message {
	mi := &file_event_logging_v4_object_complex_type_proto_msgTypes[0]
...
// Deprecated: Use ObjectComplexType.ProtoReflect.Descriptor instead.
func (*ObjectComplexType) Descriptor() ([]byte, []int) {
	return file_event_logging_v4_object_complex_type_proto_rawDescGZIP(), []int{0}
}

func (x *ObjectComplexType) GetMeta() []*AnyContentComplexType {
	if x != nil {
		return x.Meta
	}
	return nil
...
func (x *ObjectComplexType) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (x *ObjectComplexType) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *ObjectComplexType) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *ObjectComplexType) GetDescription() string {
	if x != nil {
...
func (x *ObjectComplexType) GetClassification() *ClassificationComplexType {
	if x != nil {
...
func (x *ObjectComplexType) GetState() string {
	if x != nil {
		return x.State
	}
	return ""
...
func (x *ObjectComplexType) GetGroups() *GroupsComplexType {
	if x != nil {
		return x.Groups
	}
	return nil
...
func (x *ObjectComplexType) GetPermissions() *ObjectComplexType_PermissionsType {
	if x != nil {
...
func (x *ObjectComplexType) GetTags() *MetaDataTagsComplexType {
	if x != nil {
		return x.Tags
	}
	return nil
...
func (x *ObjectComplexType) GetData() []*DataComplexType {
	if x != nil {
		return x.Data
	}
	return nil
...
// The collection of permissions associated with the object, e.g. write access being granted to a list of named users.
type ObjectComplexType_PermissionsType struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// A permission rule associated with an object, e.g. read and write access being granted to a user.
	Permission []*ObjectComplexType_PermissionsType_PermissionType `protobuf:"bytes,1,rep,name=permission,proto3" json:"permission,omitempty"`
}

func (x *ObjectComplexType_PermissionsType) Reset() {
	*x = ObjectComplexType_PermissionsType{}
	if protoimpl.UnsafeEnabled {
		mi := &file_event_logging_v4_object_complex_type_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ObjectComplexType_PermissionsType) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ObjectComplexType_PermissionsType) ProtoMessage() {}

func (x *ObjectComplexType_PermissionsType) ProtoReflect() protoreflect.Message {
	mi := &file_event_logging_v4_object_complex_type_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ObjectComplexType_PermissionsType.ProtoReflect.Descriptor instead.
func (*ObjectComplexType_PermissionsType) Descriptor() ([]byte, []int) {
	return file_event_logging_v4_object_complex_type_proto_rawDescGZIP(), []int{0, 0}
}

func (x *ObjectComplexType_PermissionsType) GetPermission() []*ObjectComplexType_PermissionsType_PermissionType {
	if x != nil {
		return x.Permission
	}
	return nil
...
// A permission rule associated with an object, e.g. read and write access being granted to a user.
type ObjectComplexType_PermissionsType_PermissionType struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ObjectComplexType_PermissionsType_PermissionType) Reset() {
	*x = ObjectComplexType_PermissionsType_PermissionType{}
	if protoimpl.UnsafeEnabled {
		mi := &file_event_logging_v4_object_complex_type_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *ObjectComplexType_PermissionsType_PermissionType) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ObjectComplexType_PermissionsType_PermissionType) ProtoMessage() {}

func (x *ObjectComplexType_PermissionsType_PermissionType) ProtoReflect() protoreflect.Message {
	mi := &file_event_logging_v4_object_complex_type_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ObjectComplexType_PermissionsType_PermissionType.ProtoReflect.Descriptor instead.
func (*ObjectComplexType_PermissionsType_PermissionType) Descriptor() ([]byte, []int) {
	return file_event_logging_v4_object_complex_type_proto_rawDescGZIP(), []int{0, 0, 0}
}

func (x *ObjectComplexType_PermissionsType_PermissionType) GetUser() *UserComplexType {
	if x != nil {
		return x.User
	}
	return nil
...
func (x *ObjectComplexType_PermissionsType_PermissionType) GetGroup() *GroupComplexType {
	if x != nil {
		return x.Group
	}
	return nil
...
func (x *ObjectComplexType_PermissionsType_PermissionType) GetAllow() []PermissionAttributeSimpleType {
	if x != nil {
		return x.Allow
	}
	return nil
...
func (x *ObjectComplexType_PermissionsType_PermissionType) GetDeny() []PermissionAttributeSimpleType {
	if x != nil {
		return x.Deny
	}
	return nil
...
var File_event_logging_v4_object_complex_type_proto protoreflect.FileDescriptor

var file_event_logging_v4_object_complex_type_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xf7, 0x07, 0x0a, 0x11, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x43, 0x6f, 0x6d, 0x70,
	...
	0x67, 0x67, 0x69, 0x6e, 0x67, 0x2e, 0x76, 0x34, 0x2e, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x43,
	...
	0x52, 0x04, 0x74, 0x61, 0x67, 0x73, 0x12, 0x3f, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x0b,
	...
	0x00, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x1a, 0xc1, 0x03, 0x0a, 0x0f, 0x50, 0x65, 0x72, 0x6d,
	0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x54, 0x79, 0x70, 0x65, 0x12, 0x6c, 0x0a, 0x0a, 0x70,
	0x65, 0x72, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x42, 0x2e, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x5f, 0x6c, 0x6f, 0x67, 0x67, 0x69, 0x6e, 0x67, 0x2e,
	0x76, 0x34, 0x2e, 0x4f, 0x62, 0x6a, 0x65, 0x63, 0x74, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x78,
	...
	0x82, 0x01, 0x02, 0x10, 0x01, 0x52, 0x04, 0x64, 0x65, 0x6e, 0x79, 0x42, 0xda, 0x01, 0x0a, 0x1c,
	0x75, 0x6b, 0x2e, 0x67, 0x6f, 0x76, 0x2e, 0x67, 0x63, 0x68, 0x71, 0x2e, 0x65, 0x76, 0x65, 0x6e,
	0x74, 0x5f, 0x6c, 0x6f, 0x67, 0x67, 0x69, 0x6e, 0x67, 0x2e, 0x76, 0x34, 0x42, 0x16, 0x4f, 0x62,
	0x6a, 0x65, 0x63, 0x74, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x78, 0x54, 0x79, 0x70, 0x65, 0x50,
...
var (
	file_event_logging_v4_object_complex_type_proto_rawDescOnce sync.Once
	file_event_logging_v4_object_complex_type_proto_rawDescData = file_event_logging_v4_object_complex_type_proto_rawDesc
)

func file_event_logging_v4_object_complex_type_proto_rawDescGZIP() []byte {
	file_event_logging_v4_object_complex_type_proto_rawDescOnce.Do(func() {
		file_event_logging_v4_object_complex_type_proto_rawDescData = protoimpl.X.CompressGZIP(file_event_logging_v4_object_complex_type_proto_rawDescData)
	})
	return file_event_logging_v4_object_complex_type_proto_rawDescData
}

var file_event_logging_v4_object_complex_type_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_event_logging_v4_object_complex_type_proto_goTypes = []interface{}{
	(*ObjectComplexType)(nil),                                // 0: event_logging.v4.ObjectComplexType
	(*ObjectComplexType_PermissionsType)(nil),                // 1: event_logging.v4.ObjectComplexType.PermissionsType
	(*ObjectComplexType_PermissionsType_PermissionType)(nil), // 2: event_logging.v4.ObjectComplexType.PermissionsType.PermissionType
...
var file_event_logging_v4_object_complex_type_proto_depIdxs = []int32{
	3,  // 0: event_logging.v4.ObjectComplexType.meta:type_name -> event_logging.v4.AnyContentComplexType
	4,  // 1: event_logging.v4.ObjectComplexType.classification:type_name -> event_logging.v4.ClassificationComplexType
	5,  // 2: event_logging.v4.ObjectComplexType.groups:type_name -> event_logging.v4.GroupsComplexType
	1,  // 3: event_logging.v4.ObjectComplexType.permissions:type_name -> event_logging.v4.ObjectComplexType.PermissionsType
	6,  // 4: event_logging.v4.ObjectComplexType.tags:type_name -> event_logging.v4.MetaDataTagsComplexType
	7,  // 5: event_logging.v4.ObjectComplexType.data:type_name -> event_logging.v4.DataComplexType
	2,  // 6: event_logging.v4.ObjectComplexType.PermissionsType.permission:type_name -> event_logging.v4.ObjectComplexType.PermissionsType.PermissionType
	8,  // 7: event_logging.v4.ObjectComplexType.PermissionsType.PermissionType.user:type_name -> event_logging.v4.UserComplexType
	9,  // 8: event_logging.v4.ObjectComplexType.PermissionsType.PermissionType.group:type_name -> event_logging.v4.GroupComplexType
	10, // 9: event_logging.v4.ObjectComplexType.PermissionsType.PermissionType.allow:type_name -> event_logging.v4.PermissionAttributeSimpleType
	10, // 10: event_logging.v4.ObjectComplexType.PermissionsType.PermissionType.deny:type_name -> event_logging.v4.PermissionAttributeSimpleType
...
func init() { file_event_logging_v4_object_complex_type_proto_init() }
func file_event_logging_v4_object_complex_type_proto_init() {
	if File_event_logging_v4_object_complex_type_proto != nil {
		return
	}
	...
	if !protoimpl.UnsafeEnabled {
		file_event_logging_v4_object_complex_type_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ObjectComplexType); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_event_logging_v4_object_complex_type_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ObjectComplexType_PermissionsType); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_event_logging_v4_object_complex_type_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ObjectComplexType_PermissionsType_PermissionType); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_event_logging_v4_object_complex_type_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_event_logging_v4_object_complex_type_proto_goTypes,
		DependencyIndexes: file_event_logging_v4_object_complex_type_proto_depIdxs,
		MessageInfos:      file_event_logging_v4_object_complex_type_proto_msgTypes,
	}.Build()
	File_event_logging_v4_object_complex_type_proto = out.File
	file_event_logging_v4_object_complex_type_proto_rawDesc = nil
	file_event_logging_v4_object_complex_type_proto_goTypes = nil
	file_event_logging_v4_object_complex_type_proto_depIdxs = nil
}
